...
!!! Note
    ++1++ will enter vertex select.

    ++2++ will enter edge select.

    ++3++ will enter face select.
...
Now lets fix the problem of the material not showing on the entire model.
...
To begin, lets play around with the shells and get used to this style of texturing.

Lets start with selecting one of the sides of the hammer, like below:
...
Lets say the hammer head is too gray, we need some flair to it!

Lets select these inner edges as seen below:
...
![](images/LP_Fantasy_Weapons/LP_Weapons%20(295).png)
...
![](images/LP_Fantasy_Weapons/LP_Weapons%20(297).png)
